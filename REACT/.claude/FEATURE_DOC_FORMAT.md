# REQ-FR-[ID]-FE: [Feature Name] – React JS
...
| Field | Value |
|-------|-------|
| Document Name | REQ-FR-[ID]-FE: [Feature Name] |
| Functional Requirement ID | FR-[X.X]-FE |
| Derived From (Backend REQ) | REQ-FR-[X.X]: [Backend Feature Name] |
...
### 2.1 Purpose
This document defines the frontend functional requirements for **[Feature Name]** functionality derived from backend REQ-FR-[ID]. The UI shall allow **[actor]** to **[primary action]** via **[method — e.g. a form, OTP input, file upload]**.
...
### 2.3 Out of Scope
- [Excluded UI concern 1] (handled by backend / separate REQ)
