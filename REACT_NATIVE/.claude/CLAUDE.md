...
This is the agent brain for this React Native project. It is auto-loaded every session.
...
| `/review src/path/to/file.tsx` | Audit a file against all 4 guardrail files |
| `/document src/path/to/file.tsx` | Generate documentation for existing code |
