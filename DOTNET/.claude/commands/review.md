...
If $ARGUMENTS is empty, respond with exactly: "Please provide a file path to review. Usage: `/review src/Application/Features/YourFeature/Commands/YourCommand.cs`" and stop.
