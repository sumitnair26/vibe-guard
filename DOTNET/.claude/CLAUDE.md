...
This is the agent brain for this .NET 8 / ASP.NET Core project. It is auto-loaded every session.
...
| `/review src/path/to/File.cs` | Audit a file against all 4 guardrail files |
| `/document src/path/to/File.cs` | Generate documentation for existing code |
