...
This is the agent brain for this Java Spring Boot project. It is auto-loaded every session.
...
| `/review src/path/to/File.java` | Audit a file against all 4 guardrail files |
| `/document src/path/to/File.java` | Generate documentation for existing code |
