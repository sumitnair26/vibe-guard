...
If $ARGUMENTS is empty, respond with exactly: "Please provide a file path to document. Usage: `/document src/main/java/com/example/app/path/to/File.java`" and stop.
...
## Usage
\```java
// Minimal working example (e.g. injecting the service or calling the endpoint)
\```
