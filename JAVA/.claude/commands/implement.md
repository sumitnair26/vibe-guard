...
You are a senior Java Spring Boot developer. Implement the feature described in the requirements document.
...
- Use Java records for DTOs; annotate with Jakarta Bean Validation constraints
- Map JPA entities to DTOs before returning from controllers — never expose entities directly
- Add a Flyway migration script for any schema change under `src/main/resources/db/migration/`
