...
cp -r vibe-guard/.claude your-project/.claude
```
...
your-project/
├── .claude/
│   ├── CLAUDE.md                  ← Agent brain (auto-loaded every session)
│   ├── CODING_STANDARDS.md        ← Style and pattern rules
│   ├── LIBRARY_ALLOWLIST.md       ← Approved dependencies
│   ├── PROJECT_DETAILS.md         ← Project context and architecture
...
│       └── debug.md               ← /debug
├── requirements/                  ← Generated by /plan-feature
└── docs/                          ← Generated by /document
```
